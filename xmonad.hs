...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_g), sendMessage $ setGaps [(L,15), (R,15), (U,40), (D,60)]) -- reset the GapSpec
...
myStartupHook = do
  ...
  spawnOnce "feh --bg-scale ~/wallpapers/space2.jpg"
  spawnOnce "picom --experimental-backends"
  spawnOnce "greenclip daemon"
  spawnOnce "macchanger wlan0 -r"
  spawn "exec ~/bin/htop4.sh"
  spawn "exec /bin/alacritty"
  spawn "exec /bin/alacritty"
------------------------------------------------------------------------
...
defaults = def {
      ...
      -- hooks, layouts
        ...
        layoutHook = gaps [(L,5), (R,5), (U,30), (D,5)] $ spacingRaw True (Border 1 1 1 1) True (Border 10 10 10 10) True $ smartBorders $ myLayout,
